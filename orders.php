...
<body>
    ...
    <div class="flex p-10 gap-10 flex-wrap">
        <?php
            ...
            if(isset( $_SESSION['login'] )) {
                ...
                $sql = "SELECT orders.order_id, orders.product_id, orders.status, product.product_name, product.description, product.price, product.image_path FROM orders INNER JOIN product on orders.product_id = product.product_id WHERE orders.email_id = '$email' AND orders.status <> 'Delievered'";
            ...
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg overflow-hidden shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="px-5 pb-5">
                    ...
                    <div class="flex items-center mt-2.5 mb-5">
                        ...
                        <span class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3"><?php echo $rating ?></span>
                    </div>
                    <div class="flex items-center">
                        <span class="text-3xl font-bold text-gray-900 dark:text-white">₹ <?php echo $price ?></span>
                        <button onclick="popup('<?php echo $status ?>')" class="ml-12 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Check Status</button>
                        
                        <a href="cancelorder.php?oid=<?php echo $id?>" class="ml-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Cancel</a>
                    </div>
                </div>
            </div>
            <?php
    ...
    <script>
        function popup(msg) {
            document.getElementById('alert').innerHTML = `
                <div id="alert-border-1" class="flex items-center p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-400 dark:bg-gray-800 dark:border-yellow-800" role="alert">
